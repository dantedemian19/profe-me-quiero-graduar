...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMENTARIOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMENTARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMENTARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMENTARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMENTARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMENTARIOS actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './anuncios.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANUNCIOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANUNCIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANUNCIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANUNCIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANUNCIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANUNCIOS actions', async () => {
      const expectedActions = [
        {

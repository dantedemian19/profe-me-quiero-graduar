...
export default class AnunciosUpdatePage {
  pageTitle: ElementFinder = element(by.id('profeMeQuieroGraduarApp.anuncios.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  titleInput: ElementFinder = element(by.css('input#anuncios-title'));
  photoInput: ElementFinder = element(by.css('input#file_photo'));
  textInput: ElementFinder = element(by.css('textarea#anuncios-text'));

...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'profe_me_quiero_graduar';
  ...
  'jhipster.mail.from' = 'profe_me_quiero_graduar@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'profe_me_quiero_graduar API';
  'jhipster.swagger.description' = 'profe_me_quiero_graduar API documentation';
  ...
  'eureka.instance.appname' = 'profe_me_quiero_graduar';
  'eureka.instance.instanceId' = 'profe_me_quiero_graduar:${random.value}';
  ...
  'cloud.config.name' = 'profe_me_quiero_graduar';
